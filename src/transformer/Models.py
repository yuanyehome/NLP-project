...
class Encoder(nn.Module):
    def __init__(self, vocab_size, embed_dim, n_layers, n_head, d_k, d_v, d_model,
        ...
        :param n_layers: 有多少个encoderlayer
        :param n_head: multihead数量
        :param d_k: key和query的维度（参考论文）
        :param d_v: value的维度（参考论文）
        :param d_model: 和embed_dim应该一直保持一致
        :param d_inner: 全连接层隐层维度
        :param pad_idx: TODO 和nn.Embedding层有关，需要继续调查
        :param n_position: TODO
        """
